...
public class halaman_History_ADMINController {
    ...
    @FXML
    private TableColumn<?, ?> idColDateUsed;

    @FXML
    private TableColumn<?, ?> idColNo;

    @FXML
    private TableColumn<?, ?> idColTittle;

    @FXML
    private TableColumn<?, ?> idColUser;
